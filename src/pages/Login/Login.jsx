        ...
        <div className="flex flex-col justify-center px-6">
          ...
          <ul className="space-y-6 text-lg text-gray-700">
            <li className="flex items-center">
              <svg className="h-6 w-6 text-indigo-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 10a8 8 0 1116 0A8 8 0 012 10zm9-3H9v4h2V7z" />
              </svg>
              Access your ATS scores
            </li>
            <li className="flex items-center">
              <svg className="h-6 w-6 text-pink-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li className="flex items-center">
              <svg className="h-6 w-6 text-emerald-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
          ...
          <form className="space-y-7">
            ...
            >
              <svg className="h-5 w-5 mr-2" viewBox="0 0 24 24">
                <path fill="#EA4335" d="M12 11.8v2.4h6.8c-.3 1.7-2 5-6.8 5-4.1 0-7.5-3.4-7.5-7.5s3.4-7.5 7.5-7.5c2.3 0 3.9.9 4.8 1.7l1.6-1.6C17.1 3.9 14.8 3 12 3 6.5 3 2 7.5 2 13s4.5 10 10 10c5.8 0 9.7-4.1 9.7-9.9 0-.7-.1-1.2-.2-1.7H12z"/>
              </svg>
              Continue with Google
            </button>
          </form>
