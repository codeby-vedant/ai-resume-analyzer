...
export default function HeroColorfulV3() {
  ...
  useEffect(() => {
    ...
    try {
      supportsMotion = !window.matchMedia("(prefers-reduced-motion: reduce)")
        .matches;
    } catch {
      supportsMotion = true;
    }
  ...
  return (
    <>
      ...
      <header
        ref={rootRef}
        className="hero-base w-full min-h-screen flex items-center relative overflow-hidden"
        aria-label="Hero"
      >
        ...
        <svg
          className="absolute left-0 right-0 top-0 w-full h-44 svg-wave animate-wave"
        ...
        <div className="container mx-auto px-6 lg:px-12 py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
          ...
          <div className="lg:col-span-6">
            <div className="max-w-2xl">
              ...
              >
                Upload your resume for instant ATS scoring, keyword suggestions,
                and tailored bullet rewrites that highlight your impact.
              </p>
          ...
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end">
            <div
              ref={parallaxRef}
              className="relative w-full max-w-md lg:max-w-lg will-change-transform transition-transform"
            >
              ...
              <div
                className="absolute -inset-6 rounded-3xl opacity-28 animate-float-slow"
                style={{
                  background:
